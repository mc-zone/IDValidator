...
switch(c){case"number":if(b=b.toString(),b.length>15)return this.error(a.error.longNumber),!1;break;case"string":break;default:return!1}if(18!==b.length)return!1;var d={body:b.slice(0,17),checkBit:b.slice(-1),type:18};return d},checkAddr:function(a){var b=this.getAddrInfo(a);return b===!1?!1:!0},getAddrInfo:function(b){if(a.gb2260.hasOwnProperty(b))return a.gb2260[b];var c=b.slice(0,4)+"00";if(a.gb2260.hasOwnProperty(c))return a.gb2260[c]+"未知地区";var c=b.slice(0,2)+"0000";return a.gb2260.hasOwnProperty(c)?a.gb2260[c]+"未知地区":!1},checkBirth:function(a){var b=(parseInt(a.slice(0,4)),parseInt(a.slice(4,6))),c=parseInt(a.slice(-2));return b>12||0==b||c>31||0==c?!1:!0},checkOrder:function(){return!0},weight:function(a){return Math.pow(2,a-1)%11},error:function(a){var b=new Error;throw b.message="IDValidator: "+a,b}},c=function(){};return c.prototype={isValid:function(a){var c=b.checkArg(a);if(c===!1)return!1;var d=c.body.slice(0,6),e=c.body.slice(6,14),f=c.body.slice(-3);if(!(b.checkAddr(d)&&b.checkBirth(e)&&b.checkOrder(f)))return!1;for(var g=[],h=18;h>1;h--){var i=b.weight(h);g[h]=i}for(var j=0,k=c.body.split(""),h=0;h<k.length;h++)j+=parseInt(k[h])*g[18-h];var l=12-j%11;return 10==l?l="X":l>10&&(l%=11),l="number"==typeof l?l.toString():l,l!==c.checkBit?!1:!0},getInfo:function(a){if(this.isValid(a)===!1)return!1;var c=b.checkArg(a),d=c.body.slice(0,6),e=c.body.slice(6,14),f=c.body.slice(-3),g={addr:b.getAddrInfo(d)||"未知",birth:[e.slice(0,4),e.slice(4,6),e.slice(-2)].join("-"),sex:f%2==0?0:1,checkBit:c.checkBit};return g}},new c};